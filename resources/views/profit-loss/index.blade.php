...
<div style="margin-bottom:18px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;background:#fff;border-radius:16px;padding:18px 24px;box-shadow:0 1px 4px rgba(0,0,0,0.06);border:1px solid #f1f5f9;">
	<div style="display:flex;align-items:center;gap:14px;">
		...
		<div style="width:48px;height:48px;border-radius:14px;background:#F27420;display:flex;align-items:center;justify-content:center;box-shadow:0 3px 12px rgba(242,116,32,0.25);">
			<i class="fa fa-calculator" style="color:#fff;font-size:20px;"></i>
		</div>
		<div>
			<h1 style="font-size:22px;font-weight:800;color:#0f172a;letter-spacing:-0.3px;margin:0;">Product Profit / Loss</h1>
			<p style="font-size:12.5px;color:#94a3b8;font-weight:500;margin:2px 0 0;">Analyze product profitability</p>
		</div>
	</div>
</div>
	<div id="profit-loss-app"
		data-currency="{{env('CURRENCY_SYMBOL', '£')}}"
		data-customer-list-api="{{route('product_profit_loss.view.customers')}}"
		data-supplier-list-api="{{route('product_profit_loss.view.suppliers')}}"
		data-product-list-api="{{route('product_profit_loss.view.products')}}"
