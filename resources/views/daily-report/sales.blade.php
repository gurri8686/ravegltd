...
@push('scripts')
<x-ajax-table-data
    tableId='daily-book-sales'
    :route="route('daily_report.daily_book_sales.ajax.sales-list')"
    method='POST'
/>
@endpush
                            ...
                            <tbody>
                                <tr>
                                    <form id="search">
                                        ...
                                        <td class="text-center"><input type="button" class="btn btn-warning filter-button" value="Reset" onClick="clearInput()"></td>
                                    </form>
                                </tr>
                            </tbody>-->
                        </table>
                         <table id="daily-book-sales" class="table c-table table-hover">
                         </table>
                    </div>
                    <!-- datatable ends -->
                </div>
