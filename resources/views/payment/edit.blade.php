...
<x-ajax-form-data
    ...
    :route="route('settings.payment_methods.edit.update', $data->id)"
    method='POST'
/>
@endpush
@section('content')
    ...
    <div class="col-md-12">
        <div class="card" style="height: 988.725px;">
            <div class="card-header">
                <h4 class="card-title" id="basic-layout-form">Update Payment Method</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="type" class="form-control" placeholder="Enter Payment Method" value="{{$data->type}}" name="type">
