...
@push('scripts')
<x-ajax-form-data
    formId='savemoduleForm'
    :route="route('management.roles.modules.create.store')"
    method='POST'
/>
@endpush
    ...
    <div class="col-md-12">
        <div class="card" style="height: 988.725px;">
            <div class="card-header">
                <h4 class="card-title" id="basic-layout-form">Add New Module</h4>
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    ...
                    <form class="form" id="savemoduleForm" name="savemoduleForm" method='POST'>
                    @csrf
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" class="form-control" placeholder="Module Name" name="title">
