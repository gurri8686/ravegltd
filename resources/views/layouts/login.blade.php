<?php
$info = \App\Models\CompanyDetailModel::info();
?>
<!DOCTYPE html>
<!--
            ...
            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                <div class="card-header border-0">
                    ...
                    <div class="card-title text-center">
                        ...
                        @if(!empty($info->invoice_logo))
                        <a href="{{env('APP_URL')}}">
                          <img height="100" src="{{config('filesystems.disks.public.url').'/'.$info->invoice_logo}}" />
                        </a>
                      @endif
                    </div>
                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>Login</span></h6>
                </div>
                <div class="card-content pt-0 mt-0">
