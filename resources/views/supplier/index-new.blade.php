...
@media (max-width: 767px) {
    ...
    .supp-header-card .supp-icon i { font-size: 16px !important; }
    .supp-header-card h1 { font-size: 17px !important; font-weight: 800 !important; margin: 0 !important; }
    .supp-header-card p { font-size: 11px !important; margin: 2px 0 0 !important; }
...
<div class="supp-header-card" style="margin-bottom:18px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;background:#fff;border-radius:16px;padding:18px 24px;box-shadow:0 1px 4px rgba(0,0,0,0.06);border:1px solid #f1f5f9;">
