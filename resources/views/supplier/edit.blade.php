...
.switchery { background-color: rgb(234, 88, 12) !important; border-color: rgb(234, 88, 12) !important; box-shadow: inset 0 0 0 16px rgb(234, 88, 12) !important; }
...
.select2-container--default.select2-container--open .select2-selection--single { border-color: rgb(234, 88, 12) !important; box-shadow: 0 0 0 3px rgba(234,88,12,0.10) !important; }
.select2-container--default.select2-container--open .select2-selection--single .select2-selection__arrow b { border-color: transparent transparent rgb(234, 88, 12) transparent !important; }
.select2-dropdown { border-radius: 12px !important; border: 1px solid #E5E7EB !important; box-shadow: 0 8px 24px rgba(0,0,0,0.10) !important; overflow: hidden !important; }
.select2-search--dropdown { padding: 8px !important; }
.select2-search--dropdown .select2-search__field { border-radius: 8px !important; border: 1px solid #E5E7EB !important; font-size: 13px !important; padding: 7px 12px !important; outline: none !important; }
...
.select2-container--default .select2-results__option--highlighted[aria-selected] { background: #FFF7ED !important; color: rgb(234, 88, 12) !important; }
.select2-container--default .select2-results__option[aria-selected=true] { background: #FEF3E6 !important; color: rgb(234, 88, 12) !important; font-weight: 600 !important; }
...
.cfa-save {
    ...
    background: linear-gradient(135deg, rgb(234, 88, 12), rgb(234, 88, 12)) !important; color: #fff !important;
...
@media (max-width: 767px), (min-width: 768px) and (max-width: 1024px) {
    ...
    /* ── Header card ── */
    .supp-edit-header { padding: 12px 14px !important; border-radius: 12px !important; margin-bottom: 10px !important; flex-wrap: nowrap !important; }
    .supp-edit-header .supp-back-btn { width: 32px !important; height: 32px !important; border-radius: 8px !important; flex-shrink: 0 !important; }
    .supp-edit-header .supp-icon { width: 38px !important; height: 38px !important; border-radius: 10px !important; flex-shrink: 0 !important; }
    .supp-edit-header .supp-icon i { font-size: 16px !important; }
    .supp-edit-header h1 { font-size: 17px !important; font-weight: 800 !important; margin: 0 !important; }
    .supp-edit-header p { font-size: 11px !important; margin: 2px 0 0 !important; }
    ...
    .form-group label {
        ...
        margin-bottom: 8px !important; display: block !important; line-height: 1 !important;
    }
    ...
    .iti__selected-flag {
        background: transparent !important; border-right: 1px solid #E5E7EB !important;
        padding: 0 10px 0 12px !important; gap: 5px !important; border-radius: 12px 0 0 12px !important;
    }
    ...
    .iti input[name="mobile"] { padding-left: 90px !important; background-image: none !important; }
    ...
    /* ── Others section ── */
    .cust-others-row { display: flex !important; flex-direction: column !important; gap: 20px !important; }
    ...
    /* ── Bootstrap switch ── */
    .bootstrap-switch { border-radius: 9px !important; border: 1.5px solid #e8edf2 !important; background: transparent !important; box-shadow: none !important; cursor: pointer !important; }
    ...
    .bootstrap-switch .bootstrap-switch-handle-on { background: rgb(234, 88, 12) !important; color: #fff !important; font-size: 12px !important; font-weight: 700 !important; border-radius: 7px 0 0 7px !important; line-height: 1 !important; }
    .bootstrap-switch .bootstrap-switch-handle-off { background: #f8fafc !important; color: #94a3b8 !important; font-size: 12px !important; font-weight: 700 !important; border-radius: 0 7px 7px 0 !important; line-height: 1 !important; }
    .bootstrap-switch .bootstrap-switch-label { background: #fff !important; min-width: 2px !important; width: 2px !important; padding: 0 !important; border-left: 1px solid #e8edf2 !important; border-right: 1px solid #e8edf2 !important; box-shadow: none !important; }

    /* ── Form actions card ── */
    .cust-form-actions {
        background: #fff !important; border-radius: 14px !important;
        box-shadow: 0 1px 6px rgba(0,0,0,0.06) !important; border: 1px solid #f0f4f8 !important;
        padding: 14px !important; display: flex !important; gap: 10px !important; justify-content: flex-end !important;
    }
...
@media (min-width: 768px) and (max-width: 1024px) {
    ...
    /* Others: Active + Remarks side by side */
...
@push('scripts')
<x-ajax-form-data
    formId='updateSupplierForm'
    :route="route('management.suppliers.edit.update', $data->id)"
    method='POST'
/>
...
$(document).ready(function() {
    ...
    document.getElementById('updateSupplierForm').addEventListener('submit', function() {
...
<div class="supp-edit-header" style="margin-bottom:18px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;background:#fff;border-radius:16px;padding:18px 24px;box-shadow:0 1px 4px rgba(0,0,0,0.06);border:1px solid #f1f5f9;">
	<div style="display:flex;align-items:center;gap:14px;">
		<a href="{{route('management.suppliers.view.index')}}" class="supp-back-btn" style="width:40px;height:40px;border-radius:10px;border:1px solid #e2e8f0;background:#fff;display:inline-flex;align-items:center;justify-content:center;text-decoration:none;color:#64748b;transition:all 0.15s;" title="Back to Suppliers"
		...
		<div class="supp-icon" style="width:48px;height:48px;border-radius:14px;background:rgb(234, 88, 12);display:flex;align-items:center;justify-content:center;box-shadow:0 3px 12px rgba(234,88,12,0.25);">
			<i class="fa fa-pencil" style="color:#fff;font-size:18px;"></i>
		</div>
		<div>
			<h1 style="font-size:22px;font-weight:800;color:#0f172a;letter-spacing:-0.3px;margin:0;">Update Supplier</h1>
			<p style="font-size:12.5px;color:#94a3b8;font-weight:500;margin:2px 0 0;">Edit supplier details</p>
		</div>
	</div>
</div>
    ...
    <div class="col-md-12">
        <div class="card" style="height: 988.725px;">
            <div class="card-content collapse show">
                <div class="card-body">
                    <form class="form" id="updateSupplierForm" name="updateSupplierForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="first_name" class="form-control" placeholder="Enter First Name" value="{{$data->name}}" name="first_name">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="icon" class="form-control" placeholder="Enter Website" name="website" value="{{$data->website}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="phone_input" class="form-control" placeholder="Enter Mobile" name="mobile" value="{{$data->mobile}}" minlength="11" pattern="[0-9]+">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="icon" class="form-control" placeholder="Enter Address Line 1" name="address1" value="{{$data->address1}}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="icon" class="form-control" placeholder="Enter Address Line 2" name="address2" value="{{$data->address2}}">
                            ...
                            <div class="row cust-col2-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="country_input" class="form-control" placeholder="Enter Country" name="country" value="{{$data->country}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="state_input" class="form-control" placeholder="Enter State" name="state" value="{{$data->state}}">
                            ...
                            <div class="row cust-col2-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="city_input" class="form-control" placeholder="Enter City" name="city" value="{{$data->city}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="zipcode" class="form-control" maxlength="10" placeholder="Enter Zipcode" name="zipcode" value="{{$data->zipcode}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="vat_number" class="form-control" placeholder="Enter Vat Number" name="vat_number" value="{{$data->vat_number}}">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="currency" id="currency">
                                            <option value="pound" @if($data->currency == "pound") selected @endif>GBP/Pound</option>
                                            <option value="dollar" @if($data->currency == "dollar") selected @endif>Dollar</option>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="bank_name" class="form-control" placeholder="Bank Name" name="bank_name" value="{{$data->bank_name}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="bank_address" class="form-control" placeholder="Bank Address" name="bank_address" value="{{$data->bank_address}}">
                                        <div class="row"><div class="col-sm-12" data-validate="bank_address"></div></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="bank_account_name" class="form-control" placeholder="Bank Account Name" name="bank_account_name" value="{{$data->bank_account_name}}">
                                        <div class="row"><div class="col-sm-12" data-validate="bank_account_name"></div></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="bank_account_number">Bank Account Number</label>
                                        <input type="text" id="bank_account_number" class="form-control" placeholder="Bank Account Number" name="bank_account_number" value="{{$data->bank_account_number}}">
                                        <div class="row"><div class="col-sm-12" data-validate="bank_account_number"></div></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="sort_code" class="form-control" placeholder="XX-XX-XX" name="sort_code" value="{{$data->sort_code}}" pattern="\d{2}-?\d{2}-?\d{2}">
                                        <div class="row"><div class="col-sm-12" data-validate="sort_code"></div></div>
                                    </div>
                                </div>
                            </div>
                            </div>{{-- /cust-form-card --}}
                            ...
                            <div class="row cust-others-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="remarks" class="form-control" placeholder="Enter Remarks/Notes" name="remarks">{{$data->remarks}}</textarea>
                        ...
                        <div class="cust-form-actions">
                            <a href="{{ route('management.suppliers.view.index') }}" class="cfa-cancel">
