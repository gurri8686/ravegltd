...
@media (max-width: 767px), (min-width: 768px) and (max-width: 1024px) {
    ...
    /* ── Header card ── */
    .supp-create-header { padding: 12px 14px !important; border-radius: 12px !important; margin-bottom: 10px !important; flex-wrap: nowrap !important; }
    .supp-create-header .supp-back-btn { width: 32px !important; height: 32px !important; border-radius: 8px !important; flex-shrink: 0 !important; }
    .supp-create-header .supp-icon { width: 38px !important; height: 38px !important; border-radius: 10px !important; flex-shrink: 0 !important; }
    .supp-create-header .supp-icon i { font-size: 16px !important; }
    .supp-create-header h1 { font-size: 17px !important; font-weight: 800 !important; margin: 0 !important; }
    .supp-create-header p { font-size: 11px !important; margin: 2px 0 0 !important; }
...
@push('scripts')
<x-ajax-form-data
    formId='saveSupplierForm'
    :route="route('management.suppliers.create.store')"
    method='POST'
/>
...
$(document).ready(function() {
    ...
    document.getElementById('saveSupplierForm').addEventListener('submit', function() {
...
<div class="supp-create-header" style="margin-bottom:18px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;background:#fff;border-radius:16px;padding:18px 24px;box-shadow:0 1px 4px rgba(0,0,0,0.06);border:1px solid #f1f5f9;">
	<div style="display:flex;align-items:center;gap:14px;">
		...
		<div>
			<h1 style="font-size:22px;font-weight:800;color:#0f172a;letter-spacing:-0.3px;margin:0;">Add Supplier</h1>
			<p style="font-size:12.5px;color:#94a3b8;font-weight:500;margin:2px 0 0;">Create a new supplier</p>
		</div>
	</div>
</div>
    ...
    <div class="col-md-12">
        <div class="card" style="height: 988.725px;">
            <div class="card-content collapse show">
                <div class="card-body">
                    <form class="form" id="saveSupplierForm" name="saveSupplierForm">
                    @csrf
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="phone_input" class="form-control" placeholder="Enter Mobile" name="mobile" minlength="11" pattern="[0-9]+">
                            ...
                            <div class="row cust-col2-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="country_input" class="form-control" placeholder="Enter Country" name="country">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="state_input" class="form-control" placeholder="Enter State" name="state">
                            ...
                            <div class="row cust-col2-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="city_input" class="form-control" placeholder="Enter City" name="city">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="zipcode" class="form-control" placeholder="Enter Zipcode" name="zipcode" maxlength="10" pattern="[0a-9z]+">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="bank_name" class="form-control" placeholder="Bank Name" name="bank_name">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="bank_address" class="form-control" placeholder="Bank Address" name="bank_address">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="bank_account_name" class="form-control" placeholder="Bank Account Name" name="bank_account_name">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="bank_account_number" class="form-control" placeholder="Bank Account Number" name="bank_account_number">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="sort-code" class="form-control" placeholder="XX-XX-XX" name="sort_code" pattern="\d{2}-?\d{2}-?\d{2}">
                                        <div class="row"><div class="col-sm-12" data-validate="sort-code"></div></div>
                                    </div>
                                </div>
                            </div>
                            </div>{{-- /cust-form-card --}}
