...
@push('scripts')
<x-ajax-table-data
    tableId='passbooks-table'
    :route="route('management.passbooks.ajax.passbooks-list')"
    method='POST'
/>
@endpush
...
<section class="users-list-wrapper">
       <div class="users-list-filter px-1">
            <div class="row  mb-1">
                ...
                @if(hasPermissionMenu('management.passbooks.create.create'))
                    <a class="btn btn-block btn-primary glow" href="{{ route('management.passbooks.create.create') }}">Create New</a>
                @endif
                </div>
            </div>
    </div>
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="passbooks-table" class="table table-hover">
                        </table>
                    </div>
                    <!-- datatable ends -->
                </div>
