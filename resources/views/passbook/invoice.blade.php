                        ...
                        <table style="width:100%">
                            <tbody>
                                <tr>
    								...
    								<td class="thick-line text-right"  style="width:25%">{{$data->order->sub_total}}</td>
    							</tr>
    							<tr>
    								<td class="no-line"  style="width:25%"></td>
    								<td class="no-line"  style="width:25%"></td>
    								<td class="no-line text-center"  style="width:25%"><strong>Porterage</strong></td>
    								<td class="no-line text-right"  style="width:25%">{{$data->order->porterage}}</td>
    							</tr>
								<tr>
    								<td class="no-line"  style="width:25%"></td>
    								<td class="no-line"  style="width:25%"></td>
    								<td class="no-line text-center"  style="width:25%"><strong>Vat</strong></td>
    								<td class="no-line text-right"  style="width:25%">{{$data->order->vat}}</td>
    							</tr>
    							<tr>
    								<td class="no-line"  style="width:25%"></td>
    								<td class="no-line"  style="width:25%"></td>
    								<td class="no-line text-center"  style="width:25%"><strong>Total</strong></td>
    								<td class="no-line text-right"  style="width:25%">{{$data->order->total}}</td>
    							</tr>
                            </tbody>
                        </table>
    				</div>
