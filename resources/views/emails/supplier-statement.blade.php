            ...
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 6px 24px rgba(15,17,21,0.08);">
                ...
                <tr>
                    <td style="background:#ea580c;padding:26px 32px;">
                        ...
                        <div style="font-size:12px;color:#ffdcc4;margin-top:4px;letter-spacing:0.3px;">SUPPLIER STATEMENT</div>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td style="padding:16px 18px;">
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="font-size:12.5px;color:#6b7280;padding:5px 0;">Supplier</td>
                                            <td style="font-size:12.5px;color:#0f1115;font-weight:600;text-align:right;padding:5px 0;">{{ $data['supplier_name'] }}</td>
                                        </tr>
                                        <tr>
                ...
                <tr>
                    <td style="padding:14px 32px 28px;">
                        <p style="font-size:12.5px;color:#6b7280;line-height:1.6;margin:0;">
                            For any queries regarding this statement, please don't hesitate to contact us.
                        </p>
                ...
                <tr>
                    <td style="background:#0f1115;padding:18px 32px;">
                        <div style="font-size:11px;color:#9ca3af;line-height:1.6;">
                            ...
                            Statement generated on {{ $data['generated_on'] }} &nbsp;&bull;&nbsp; Please do not reply to this email.
                        </div>
                    </td>
                </tr>
