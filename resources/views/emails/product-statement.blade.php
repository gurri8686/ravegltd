            ...
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 6px 24px rgba(15,17,21,0.08);">
                ...
                <tr>
                    <td style="background:#ea580c;padding:26px 32px;">
                        ...
                        <div style="font-size:12px;color:#ffdcc4;margin-top:4px;letter-spacing:0.3px;">PRODUCT HISTORY</div>
                    </td>
                </tr>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e8e8ec;border-radius:10px;margin:0 0 22px;">
                            <tr>
                                <td style="background:#fafafb;border-bottom:1px solid #eeeeef;padding:11px 18px;border-radius:10px 10px 0 0;">
                                    <span style="font-size:11px;font-weight:700;color:#9ca3af;letter-spacing:0.6px;">REPORT SUMMARY</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:16px 18px;">
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="font-size:12.5px;color:#6b7280;padding:5px 0;">Product</td>
                                            <td style="font-size:12.5px;color:#0f1115;font-weight:600;text-align:right;padding:5px 0;">{{ $data['product_name'] }}</td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:12.5px;color:#6b7280;padding:5px 0;border-top:1px solid #f0f0f2;">Period</td>
                                        ...
                                        <tr>
                                            <td style="font-size:12.5px;color:#6b7280;padding:5px 0;border-top:1px solid #f0f0f2;">Total Purchases</td>
                                            <td style="font-size:12.5px;color:#0f1115;font-weight:600;text-align:right;padding:5px 0;border-top:1px solid #f0f0f2;">{{ $data['total_purchases'] }}</td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:13px;color:#0f1115;font-weight:700;padding:9px 0 3px;border-top:1px solid #f0f0f2;">Total Sales</td>
                                            <td style="font-size:15px;color:#15803d;font-weight:700;text-align:right;padding:9px 0 3px;border-top:1px solid #f0f0f2;">{{ $data['total_sales'] }}</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#fff7ed;border:1px solid #fed7aa;border-radius:10px;margin:0 0 8px;">
                            <tr>
                                ...
                                <td style="padding:13px 16px 13px 0;vertical-align:middle;">
                                    <div style="font-size:12.5px;font-weight:700;color:#9a3412;">Detailed report attached (PDF)</div>
                                    <div style="font-size:11.5px;color:#c2671f;margin-top:2px;">Open the attachment to view all transactions for this product.</div>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding:14px 32px 28px;">
                        <p style="font-size:12.5px;color:#6b7280;line-height:1.6;margin:0;">
                            For any queries regarding this report, please don't hesitate to contact us.
                        </p>
                ...
                <tr>
                    <td style="background:#0f1115;padding:18px 32px;">
                        <div style="font-size:11px;color:#9ca3af;line-height:1.6;">
                            ...
                            Report generated on {{ $data['generated_on'] }} &nbsp;&bull;&nbsp; Please do not reply to this email.
                        </div>
                    </td>
                </tr>
