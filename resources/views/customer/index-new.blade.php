...
<div class="cust-header-card" style="margin-bottom:18px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;background:#fff;border-radius:16px;padding:18px 24px;box-shadow:0 1px 4px rgba(0,0,0,0.06);border:1px solid #f1f5f9;">
	...
	<a href="{{route('management.customers.create.create')}}" class="cust-create-btn" style="height:40px;padding:0 20px;border-radius:10px;border:none;background:#F27420;color:#fff;font-size:13px;font-weight:700;text-decoration:none;display:inline-flex;align-items:center;gap:6px;box-shadow:0 2px 8px rgba(242,116,32,0.3);">
