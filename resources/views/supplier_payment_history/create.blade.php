...
<div style="margin-bottom:18px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;background:#fff;border-radius:16px;padding:18px 24px;box-shadow:0 1px 4px rgba(0,0,0,0.06);border:1px solid #f1f5f9;">
	<div style="display:flex;align-items:center;gap:14px;">
		...
		<div>
			<h1 style="font-size:22px;font-weight:800;color:#0f172a;letter-spacing:-0.3px;margin:0;">Supplier Payment History</h1>
			<p style="font-size:12.5px;color:#94a3b8;font-weight:500;margin:2px 0 0;">View payment records</p>
		</div>
	</div>
</div>
	<div id="supplier-payment-history-app"
		data-currency="{{env('CURRENCY_SYMBOL', '£')}}"
		data-list-payments-api="/supplier_payment_history/view"
		data-list-suppliers-api="/supplier_payment_history/view/suppliers"
		data-delete-payment-api="/supplier_payment_history/delete"
	></div>
</section>
@endsection
