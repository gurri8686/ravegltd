...
<link rel='stylesheet' type='text/css' property='stylesheet' href='//ravegltd.com/_debugbar/assets/stylesheets?v=1739449356&theme=auto' data-turbolinks-eval='false' data-turbo-eval='false'><script src='//ravegltd.com/_debugbar/assets/javascript?v=1739449356' data-turbolinks-eval='false' data-turbo-eval='false'></script><script data-turbo-eval="false">jQuery.noConflict(true);</script>
...
<div class="container">
        ...
        <tbody>
          <tr>
			...
			<span style="">
              ...
              @isset($companyDetails->address1) <p>{{$companyDetails->address1}} @endisset
              
              @isset($companyDetails->country) ,{{$companyDetails->country}}, @endisset
              
              @isset($companyDetails->zipcode){{$companyDetails->zipcode}}</p> @endisset
              
              @isset($companyDetails->country)<p><span>Email: </span>{{$companyDetails->email}}, @endisset
              
              @isset($companyDetails->telephone)<span>Phone: </span>+{{$companyDetails->telephone}}</p> @endisset
          ...
          <tr>
            <td style="text-align: left;">
				...
				{{($customer->address1)?", Address: ".$customer->address1:""}}
    			</address>
            </td>
            <td></td>
			<td></td>
    	...
    	<div class="col-md-12">
    		<div class="panel panel-default">
    			<div class="panel-heading">
    				<h3 class="panel-title"><strong>Order Summary, #<b>{{$data->id}}, Date: <b>{{ $data->created_at }}</strong></h3>
    			</div>
    					...
    					<table class="table table-condensed">
    						...
    						<tbody>
								<tr>
        							...
        							<td class="align-center"><strong>Price</strong></td>
        							<td class="align-center"><strong>Quantity</strong></td>
    							...
    							@foreach ($data->products as $item)
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            ?>
                                             {{$getjson->name}} (<i>{{$item->remarks}}</i>)
                                        </td>
                                        <td class="align-center">{{$item->unit_price}}</td>
                                        <td class="align-center">{{$item->quantity}}</td>
                                        <td class="align-right">{{env('CURRENCY_SYMBOL', '£')}} {{$item->sub_total}}</td>
										<?php 
								...
								<tr>
										<td></td>
										<td></td>
										<td class="align-center"><strong>Subtotal</strong></td><td class="align-right">{{env('CURRENCY_SYMBOL', '£')}} {{$subtoal}}</td>
								</tr>
								<tr>
									<td></td>
									<td></td>
									<td class="align-center"><strong>Porterage</strong></td><td class="align-right">{{env('CURRENCY_SYMBOL', '£')}} {{env('PORTERAGE')}}</td>
								</tr>
								<tr>
									<td></td>
									<td></td>
									<td class="align-center"><strong>Vat</strong></td><td class="align-right">{{env('VAT')}}%</td>
								</tr>
								<?php
								...
								<tr>
									<td></td>
									<td></td>
									<td class="align-center"><strong>Total</strong></td><td class="align-right">{{env('CURRENCY_SYMBOL', '£')}} {{($total)}}</td>
								</tr>
	...
	@endforeach
	<div class="align-right" style="margin:10px 0 20px 0;">
	<h4><b>Grand Total : {{env('CURRENCY_SYMBOL', '£')}} {{array_sum($grand_total)}}</b></h4>
	</div>
</div>
</body>
</html>