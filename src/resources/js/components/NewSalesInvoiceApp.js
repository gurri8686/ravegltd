...
export default function NewSalesInvoiceApp(props) {
    ...
    <div style={{maxWidth:'1440px',margin:'0 auto'}}>
        <style>{`
            @keyframes nsiSheetUp{from{transform:translateY(100%);}to{transform:translateY(0);}}
        ...
        {continued && <div style={{background:'#fff',borderRadius:'16px',border:'1px solid #eaecf2',boxShadow:'0 1px 4px rgba(0,0,0,0.04)',overflow:'hidden'}}>
            ...
            <div style={isMobile
              ...
              <div style={isMobile
                ? {position:'relative',background:'#fff',borderTopLeftRadius:'18px',borderTopRightRadius:'18px',boxShadow:'0 -8px 30px rgba(0,0,0,0.18)',maxHeight:'90vh',overflowY:'auto',paddingBottom:'8px',animation:'nsiSheetUp 0.22s ease'}
                : {}}>
                {isMobile && (
            ...
            <div style={{padding:'16px 20px',background:'#fff',borderBottom: isMobile ? 'none' : '1px solid #eef2f7'}}>
